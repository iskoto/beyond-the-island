...
public interface IInteractable
{
    ...
    // String function that receives a custom interaction message that is displayed when we hover our mouse over an element
    string GetInteractPrompt();

    // While interacting with the object.. ("E")
    void OnInteract();
}
